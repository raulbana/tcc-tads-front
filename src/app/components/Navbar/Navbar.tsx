  ...
  return (
    <div className="flex flex-col h-screen bg-gray-01">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        <div
          className={`absolute inset-y-0 left-0 bg-white border-r-2 border-gray-03 shadow-lg transition-transform duration-300 ease-in-out z-40 ${isOpen ? "w-full sm:w-80 translate-x-0" : "-translate-x-full"
            }`}
        >
        ...
        <main
          className={`transition-all duration-300 ease-in-out flex-1 overflow-y-auto bg-gray-02 ${isOpen ? "sm:ml-80" : "ml-0"
            }`}
        >
